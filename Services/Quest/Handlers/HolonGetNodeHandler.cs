...
/// <summary>Handles <see cref="QuestNodeType.HolonGet"/> — relocated verbatim from QuestManager.</summary>
public sealed class HolonGetNodeHandler : IQuestNodeHandler
{
    private readonly IHolonManager _holonManager;

    public HolonGetNodeHandler(IHolonManager holonManager) => _holonManager = holonManager;

    public QuestNodeType NodeType => QuestNodeType.HolonGet;
