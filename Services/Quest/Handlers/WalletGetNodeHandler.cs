...
/// <summary>Handles <see cref="QuestNodeType.WalletGet"/> — relocated verbatim from QuestManager.</summary>
public sealed class WalletGetNodeHandler : IQuestNodeHandler
{
    private readonly IWalletManager _walletManager;

    public WalletGetNodeHandler(IWalletManager walletManager) => _walletManager = walletManager;

    public QuestNodeType NodeType => QuestNodeType.WalletGet;
