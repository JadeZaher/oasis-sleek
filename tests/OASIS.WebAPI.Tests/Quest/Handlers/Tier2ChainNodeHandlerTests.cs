...
public class Tier2ChainNodeHandlerTests
{
    ...
    public async Task SwapNodeHandler_ForwardsRequest_NoRateComputedInHandler()
    {
        ...
        mgr.Setup(m => m.GetSwapTransactionAsync(It.IsAny<SwapExecuteRequest>(), It.IsAny<string?>()))
           ...
           .ReturnsAsync(new OASISResult<SwapQuoteResponse> { Result = new SwapQuoteResponse() });
    ...
    public async Task SwapNodeHandler_ManagerError_MapsToFailed()
    {
        var mgr = new Mock<ISwapManager>();
        mgr.Setup(m => m.GetSwapTransactionAsync(It.IsAny<SwapExecuteRequest>(), It.IsAny<string?>()))
           .ReturnsAsync(new OASISResult<SwapQuoteResponse> { IsError = true, Message = "dex down" });
    ...
    public async Task GrantNodeHandler_Mints_WithRunContextAvatar_BodyAvatarIgnored()
    {
        ...
        nft.Setup(m => m.MintAsync(It.IsAny<NftMintRequest>(), runAvatar, It.IsAny<OASISRequest?>()))
        ...
        result.IsError.Should().BeFalse();
        nft.Verify(m => m.MintAsync(It.IsAny<NftMintRequest>(), runAvatar, It.IsAny<OASISRequest?>()), Times.Once);
        holon.Verify(m => m.UpdateAsync(It.IsAny<Guid>(), It.IsAny<HolonUpdateModel>(), It.IsAny<Guid?>(), It.IsAny<OASISRequest?>()), Times.Never);
    }
    ...
    public async Task GrantNodeHandler_WithHolonId_LinksTokenIdAndChainId()
    {
        ...
        holon.Setup(m => m.UpdateAsync(holonId, It.IsAny<HolonUpdateModel>(), It.IsAny<Guid?>(), It.IsAny<OASISRequest?>()))
             .Callback<Guid, HolonUpdateModel, Guid?, OASISRequest?>((_, u, _, _) => capturedUpdate = u)
        ...
        result.IsError.Should().BeFalse();
        holon.Verify(m => m.UpdateAsync(holonId, It.IsAny<HolonUpdateModel>(), It.IsAny<Guid?>(), It.IsAny<OASISRequest?>()), Times.Once);
    ...
    {
        var nft = new Mock<INftManager>();
        nft.Setup(m => m.MintAsync(It.IsAny<NftMintRequest>(), It.IsAny<Guid>(), It.IsAny<OASISRequest?>()))
           .ReturnsAsync(new OASISResult<IBlockchainOperation> { IsError = true, Message = "kyc fail" });
        var holon = new Mock<IHolonManager>();
    ...
    public async Task TransferNodeHandler_Transfers_WithRunContextAvatar_BodyAvatarIgnored()
    {
        ...
        mgr.Setup(m => m.TransferAsync(nftId, It.IsAny<NftTransferRequest>(), runAvatar, It.IsAny<OASISRequest?>()))
           .ReturnsAsync(new OASISResult<IBlockchainOperation> { Result = new BlockchainOperation() });
        ...
        result.IsError.Should().BeFalse();
        mgr.Verify(m => m.TransferAsync(nftId, It.IsAny<NftTransferRequest>(), runAvatar, It.IsAny<OASISRequest?>()), Times.Once);
    }
    ...
    public async Task RefundNodeHandler_ReverseTransfer_WithRunContextAvatar()
    {
        ...
        var nftId = Guid.NewGuid();
        var mgr = new Mock<INftManager>();
        mgr.Setup(m => m.GetAsync(nftId, It.IsAny<OASISRequest?>()))
           .ReturnsAsync(new OASISResult<INft> { Result = new Holon { Id = nftId, AssetType = "NFT" } });
        mgr.Setup(m => m.TransferAsync(nftId, It.IsAny<NftTransferRequest>(), runAvatar, It.IsAny<OASISRequest?>()))
           .ReturnsAsync(new OASISResult<IBlockchainOperation> { Result = new BlockchainOperation() });
    ...
    public async Task RefundNodeHandler_Soulbound_FailsClosed_NoTransfer()
    {
        ...
        var mgr = new Mock<INftManager>();
        mgr.Setup(m => m.GetAsync(nftId, It.IsAny<OASISRequest?>()))
           .ReturnsAsync(new OASISResult<INft>
           {
               Result = new Holon
               {
                   Id = nftId,
        ...
        mgr.Verify(m => m.TransferAsync(It.IsAny<Guid>(), It.IsAny<NftTransferRequest>(), It.IsAny<Guid>(), It.IsAny<OASISRequest?>()), Times.Never);
    }
}
